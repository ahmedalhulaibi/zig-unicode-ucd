...
//
// Based on the source file: https://unicode.org/Public/18.0.0/ucd/PropertyValueAliases.txt
//
// zig fmt: off
...
pub const data = [_][3][:0]const u8{
    ...
    .{ "blk", "Archaic_Cuneiform_Numerals", "Archaic_Cuneiform_Numerals" },
    ...
    .{ "blk", "Batak", "Batak" },
    .{ "blk", "Bengali", "Bengali" },
    .{ "blk", "Bengali_Sup", "Bengali_Supplement" },
    ...
    .{ "blk", "Jurchen", "Jurchen" },
    .{ "blk", "Jurchen_Radicals", "Jurchen_Radicals" },
    .{ "blk", "Kaithi", "Kaithi" },
    ...
    .{ "blk", "Misc_Arrows_Ext", "Miscellaneous_Symbols_And_Arrows_Extended" },
    ...
    .{ "blk", "Music_Sup", "Musical_Symbols_Supplement" },
    .{ "blk", "Myanmar", "Myanmar" },
    ...
    .{ "IDSU", "T", "Yes" },
    .{ "IDSU", "True", "Yes" },
    .{ "ID_Compat_Math_Continue", "N", "No" },
    .{ "ID_Compat_Math_Continue", "F", "No" },
    .{ "ID_Compat_Math_Continue", "False", "No" },
    .{ "ID_Compat_Math_Continue", "Y", "Yes" },
    .{ "ID_Compat_Math_Continue", "T", "Yes" },
    .{ "ID_Compat_Math_Continue", "True", "Yes" },
    .{ "ID_Compat_Math_Start", "N", "No" },
    .{ "ID_Compat_Math_Start", "F", "No" },
    .{ "ID_Compat_Math_Start", "False", "No" },
    .{ "ID_Compat_Math_Start", "Y", "Yes" },
    .{ "ID_Compat_Math_Start", "T", "Yes" },
    .{ "ID_Compat_Math_Start", "True", "Yes" },
    .{ "IDC", "N", "No" },
    .{ "IDC", "F", "No" },
    .{ "IDC", "False", "No" },
    .{ "IDC", "Y", "Yes" },
    ...
    .{ "jg", "Crown_Ain", "Crown_Ain" },
    .{ "jg", "Crown_Beh", "Crown_Beh" },
    .{ "jg", "Crown_Feh", "Crown_Feh" },
    .{ "jg", "Crown_Hah", "Crown_Hah" },
    .{ "jg", "Crown_Heh", "Crown_Heh" },
    .{ "jg", "Crown_Kaf", "Crown_Kaf" },
    .{ "jg", "Crown_Meem", "Crown_Meem" },
    .{ "jg", "Crown_Sad", "Crown_Sad" },
    .{ "jg", "Crown_Seen", "Crown_Seen" },
    .{ "jg", "Crown_Tah", "Crown_Tah" },
    .{ "jg", "Dal", "Dal" },
    ...
    .{ "jg", "Teh_Marbuta_Goal", "Teh_Marbuta_Goal" },
    .{ "jg", "Hamza_On_Heh_Goal", "Teh_Marbuta_Goal" },
    .{ "jg", "Teth", "Teth" },
    ...
    .{ "kEH_NoMirror", "N", "No" },
    .{ "kEH_NoMirror", "F", "No" },
    .{ "kEH_NoMirror", "False", "No" },
    .{ "kEH_NoMirror", "Y", "Yes" },
    .{ "kEH_NoMirror", "T", "Yes" },
    .{ "kEH_NoMirror", "True", "Yes" },
    .{ "kEH_NoRotate", "N", "No" },
    .{ "kEH_NoRotate", "F", "No" },
    .{ "kEH_NoRotate", "False", "No" },
    .{ "kEH_NoRotate", "Y", "Yes" },
    .{ "kEH_NoRotate", "T", "Yes" },
    .{ "kEH_NoRotate", "True", "Yes" },
};